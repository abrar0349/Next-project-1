...
function Card4({ pic }) {
  ...
  return (
    <div className = "overflow-hidden w-[80%] sm:w-[50%] md:w-[30%] h-[60vh] cursor-pointer" >
        <div
         className="w-full h-full flex flex-col justify-end gap-y-2 px-6 pb-8 hover:scale-110"
         style={{
